...
const galleryData = [
  ...
  { category: 'design', src: 'assets/gallery/design/2.png', caption: { es: '', en: '', fr: '' } },
  { category: 'design', src: 'assets/gallery/design/3.png', caption: { es: '', en: '', fr: '' } },
  { category: 'design', src: 'assets/gallery/design/4.png', caption: { es: '', en: '', fr: '' } },
  { category: 'design', src: 'assets/gallery/design/5.png', caption: { es: '', en: '', fr: '' } },
  { category: 'design', src: 'assets/gallery/design/6.png', caption: { es: '', en: '', fr: '' } },

    // ---------- HMI ----------
  { category: 'hmi', src: 'assets/gallery/hmi/1.png', caption: { es: '', en: '', fr: '' } },
  { category: 'hmi', src: 'assets/gallery/hmi/2.png', caption: { es: '', en: '', fr: '' } },
  { category: 'hmi', src: 'assets/gallery/hmi/3.png', caption: { es: '', en: '', fr: '' } },
  ...
  // ---------- PLC ----------
  { category: 'plc', src: 'assets/gallery/plc/1.png', caption: { es: '', en: '', fr: '' } },

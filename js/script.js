...
const translations = {
  es: {
    ...
    mod2Tag: 'MOD-02 // CERTIFICACIONES', mod2Title: '+20 certificaciones oficiales',
    mod2Sub: 'Selección de las más relevantes:',
    certHeadArea: 'ÁREA', certHeadName: 'CERTIFICACIÓN',
    certArea1: 'General', cert1: 'SITRAIN Siemens Partner Academy — TIA Portal, WinCC, PCS 7, SIMOTION, Safety',
    certArea2: 'Auto & PLC', cert2: 'Automatización Industrial y PLCs: Programación avanzada, desarrollo de lógica y arquitecturas de control (IEC 61131-3).',
    certArea3: 'Potencia', cert3: 'Sistemas de Potencia y Subestaciones: Diseño, diagnóstico y mantenimiento de sistemas de potencia e infraestructura de AT.',
    certArea4: 'Instalación', cert4: 'Instalaciones Eléctricas: Ejecución y supervisión de instalaciones y montajes eléctricos a nivel industrial y comercial.',
    certArea5: 'Procesos', cert5: 'Instrumentación de Procesos: Integración de sensores, telemetría continua y sistemas de instrumentación para control.',
  ...
  en: {
    ...
    mod2Tag: 'MOD-02 // CERTIFICATIONS', mod2Title: '+20 official certifications',
    mod2Sub: 'A selection of the most relevant:',
    certHeadArea: 'AREA', certHeadName: 'CERTIFICATION',
    certArea1: 'General', cert1: 'SITRAIN Siemens Partner Academy — TIA Portal, WinCC, PCS 7, SIMOTION, Safety',
    certArea2: 'Auto & PLC', cert2: 'Industrial Automation and PLCs: Advanced programming, logic development, and control architectures (IEC 61131-3).',
    certArea3: 'Power', cert3: 'Power Systems and Substations: Design, diagnostics, and maintenance of power systems and HV infrastructure.',
    certArea4: 'Installation', cert4: 'Electrical Installations: Execution and supervision of electrical installations and assemblies at industrial and commercial levels.',
    certArea5: 'Processes', cert5: 'Process Instrumentation: Sensor integration, continuous telemetry, and instrumentation systems for control.',
  ...
  fr: {
    ...
    mod2Tag: 'MOD-02 // CERTIFICATIONS', mod2Title: '+20 certifications officielles',
    mod2Sub: 'Sélection des plus pertinentes :',
    certHeadArea: 'DOMAINE', certHeadName: 'CERTIFICATION',
    certArea1: 'Général', cert1: 'SITRAIN Siemens Partner Academy — TIA Portal, WinCC, PCS 7, SIMOTION, Safety',
    certArea2: 'Auto & API', cert2: 'Automatisation Industrielle et API : Programmation avancée, développement logique et architectures de contrôle (IEC 61131-3).',
    certArea3: 'Puissance', cert3: 'Systèmes de Puissance et Sous-stations : Conception, diagnostic et maintenance des systèmes de puissance et infrastructures HT.',
    certArea4: 'Installation', cert4: 'Installations Électriques : Exécution et supervision d\'installations et de montages électriques aux niveaux industriel et commercial.',
    certArea5: 'Procédés', cert5: 'Instrumentation de Procédés : Intégration de capteurs, télémétrie continue et systèmes d\'instrumentation pour le contrôle.',
